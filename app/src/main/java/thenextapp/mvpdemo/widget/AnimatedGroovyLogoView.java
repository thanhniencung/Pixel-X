package thenextapp.mvpdemo.widget;
...
import thenextapp.mvpdemo.uitil.LogoPaths;
import thenextapp.mvpdemo.uitil.MathUtil;
import thenextapp.mvpdemo.uitil.SvgPathParser;

/**
 * Created by Sandy on 12/26/15.
 */
public class AnimatedGroovyLogoView extends View {

    private static final String TAG = "AnimatedGroovyLogoView";
    ...
    public AnimatedGroovyLogoView(Context context) {
        super(context);
        init();
    }

    public AnimatedGroovyLogoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AnimatedGroovyLogoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void rebuildGlyphData() {
        ...
        for (int i = 0; i < LogoPaths.GLYPHS.length; i++) {
            ...
            try {
                ...
                LogUtils.error(TAG, "Couldn't parse path", e);
            }
